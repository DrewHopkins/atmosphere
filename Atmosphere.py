...
def constants():# constants
    ...
    return gamma, R, g, S, keyAltitudes

#make sure constants is called no matter what
...
def seaLevel():
    ...
    return t_0, p_0, d_0, a_0, v_0, beta
...
def atmosphere(endAlt):
    ...
    points = 100000 #accuarcy of graphs
...
def plots():
    y, temps, pressures, densities, speedOfSound, viscocity, beta = atmosphere(endAlt = keyAltitudes[-1])
...
def propertiesByAltitude(currentAlt):
    ...
    return (temps[-1], pressures[-1], densities[-1], speedOfSound[-1], viscocity[-1])
